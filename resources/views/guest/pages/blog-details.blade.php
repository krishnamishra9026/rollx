...
<head>
  ...
  <title>Blog Details - Roll.X Bootstrap Template</title>
          ...
          <section id="blog-details" class="blog-details section">
            <div class="container">
              ...
              <article class="article">
                ...
                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details">{{ $blog->admin->firstname }} {{ $blog->admin->lastname }}</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details"><time datetime="2020-01-01">{{ date('M d Y', strtotime($blog->created_at)) }}</time></a></li>
                  </ul>
                </div><!-- End meta top -->
