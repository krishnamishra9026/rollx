...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <div class="row">
            <form id="serviceForm" method="POST" action="{{ route('franchise.order.sales.store') }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <label for="quantity" class="col-md-4 col-form-label text-md-start">Avilable Order {{ __('Quantity') }} : {{ $order->quantity }}</label>
                                ...
                                <div class="col-md-9">
                                    <input id="quantity" type="number"
                                        ...
                                        placeholder="Enter Model Number" min="1" max="{{ $order->quantity }}" 
