...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <div class="row">
            <form id="serviceForm" method="POST" action="{{ route('admin.orders.update', $purchase_order->id) }}"
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="gallery">
                                        @foreach ($purchase_order->images as $image)
                                            <img src="{{ asset('storage/uploads/orders/' . $purchase_order->id . '/images' . '/' . $image->name) }}"
                                        ...
                                        @foreach ($purchase_order->documents as $document)
                                            <span class="me-2 mt-2 mb-2 border text-center py-4"
                                                style="width: 150px; height: 100px;"><a
                                                    href="{{ asset('storage/uploads/orders/' . $purchase_order->id . '/documents' . '/' . $document->name) }}"
