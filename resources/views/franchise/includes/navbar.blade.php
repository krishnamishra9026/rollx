            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg notification-dropdown">
                ...
                <div style="max-height: 230px;" data-simplebar>
                    <div id="notification-container">
                        @include('franchise.includes.notifications-list')
                    </div>
                </div>
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                ...
                <a href="#" class="dropdown-item notify-item d-sm-block d-md-none">
                    ...
                    <span class="account-user-avatar">
                    @isset(Auth::guard('franchise')->user()->avatar)
                        <img  height="30" width="30" src="{{ asset('storage/uploads/franchise/'.Auth::guard('franchise')->user()->avatar) }}" alt="user-image" class="rounded-circle">
                    @else
                        <img  height="30" width="30" src="{{ asset('assets/images/users/avatar.png') }}" alt="user-image" class="rounded-circle">
                    @endisset
                    </span>
                    <span >{{ Auth::guard('franchise')->user()->firstname }}
                        {{ Auth::guard('franchise')->user()->lastname }}</span>
                </a>

                <a href="#" class="dropdown-item notify-item">
                    <span ><strong>Points</strong> : {{ Auth::guard('franchise')->user()->balance }}</span>
                </a>

                <!-- item-->
                <a href="{{ route('franchise.my-account.edit', Auth::guard('franchise')->id()) }}" class="dropdown-item notify-item">
