    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('franchise.purchase-orders.add-history', $purchase_order->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                        <div class="row mb-2">
                                    ...
                                    @foreach ($purchase_order->histories as $history)
                                        <tr>
                                            ...
                                            @if($history->status_changed_by == 'administrator')
                                                ...
                                                @else
                                                <td>{{ \App\Models\Supplier::find($history->status_changer_id)->firstname }} {{ \App\Models\Supplier::find($history->status_changer_id)->lastname }}</td>
                                                @endif
                                            <td>
