...
@section('content')
    <div class="container-fluid Purchase_Orders">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                                <a href="{{ route('franchise.purchase-orders.index') }}" class="btn btn-sm btn-primary float-end me-1"><i
        ...
        @include('franchise.purchase-orders.filter')
        <div class="row">
            <div class="col-12">
                <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="{{ route('franchise.purchase-orders.show', $order->id) }}"
...
@push('scripts')
    ...
    <script>
        function changeStatus(id, value) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("franchise.purchase-orders.change-status") }}',
                data: formData,
                dataType: 'json',
                beforeSend: function() {
