...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('admin.purchase-orders.index') }}" class="btn btn-sm btn-primary me-1"><i
        ...
        <div class="row">
            <div class="col-12">
                <form id="orderForm" method="POST" action="{{ route('admin.purchase-orders.update', $order->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <div class="col-md-9">
                                                    <select id="equipment_assemble_type"
                                                        ...
                                                        <option value="franchise"
                                                            {{ old('equipment_assemble_type', $order->equipment_assemble_type) == 'franchise' ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <span class="uploaded-document-list d-flex">
                                                        @foreach($order->documents as  $document)
                                                            <span class="me-2 mt-2 mb-2 border text-center py-4" style="width: 150px; height: 100px;"><a href="{{ asset('storage/uploads/orders/'.$order->id.'/documents'.'/'.$document->name) }}" download="">{{ $document->name }}</a></span>
                                                        @endforeach
                                                    </span>
                                                </div>
                                            </div>
