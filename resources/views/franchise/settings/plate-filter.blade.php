<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('franchise.settings.products-plate') }}" id="filterForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <a href="{{ route('franchise.settings.products-plate') }}" class="btn btn-sm btn-primary float-end me-1"><i  class="mdi mdi-refresh"></i> Reset</a>
