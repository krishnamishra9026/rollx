            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('chef.orders.create', ['product_id' => $product->id]) }}" class="btn btn-sm btn-primary me-1 mb-2">Place Order</a>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card" style="min-height: 303px;">
                    <div class="card-header bg-dark text-white">
                        ...
                        <a href="{{ route('chef.products.edit', $product->id) }}" class="text-white float-end mt-1"><i
