<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('chef.products.index') }}" id="filterForm">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-end" style="margin-top: 32px">
                            <a href="{{ route('chef.products.create') }}" class="btn btn-sm btn-dark float-end"><i
                                class="mdi mdi-plus"></i> Add
                            Product</a>
                        <a href="{{ route('chef.products.index') }}" class="btn btn-sm btn-primary float-end me-1"><i
