                                ...
                                <table id="basic-datatable" class="table table-striped border dt-responsive nowrap w-100"
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                <td>{{ $product->id }}</td>
                                                <td><a href="{{ route('chef.products.show', $product->id) }}"
                                               ...
                                               <td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('chef.products.edit', $product->id) }}"
                                                            class="dropdown-item"><i class="fa fa-edit me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a href="{{ route('chef.products.show', $product->id) }}"
                                                            class="dropdown-item"><i class="fa fa-eye me-1"></i>
                                                            View</a>

                                                        <a href="{{ route('chef.orders.create', ['product_id' => $product->id]) }}"
                                                            class="dropdown-item"><i class="fa fa-eye me-1"></i>
                                                            Place Order</a>
                                                        ...
                                                        <form id='delete-form{{ $product->id }}'
                                                            action='{{ route('chef.products.destroy', $product->id) }}'
                                                            method='POST'>
