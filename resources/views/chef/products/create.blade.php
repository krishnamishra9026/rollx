...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('chef.products.index') }}" class="btn btn-sm btn-primary me-1"><i
        ...
        <!-- end page title -->
        <div class="row">
            <form id="serviceForm" method="POST" action="{{ route('chef.products.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
