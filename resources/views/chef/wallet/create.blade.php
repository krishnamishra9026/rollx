...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <div class="row">
            <form id="serviceForm" method="POST" action="{{ route('admin.purchase-orders.store') }}"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <input id="project_reference" type="text"
                                        class="form-control @error('project_reference') is-invalid @enderror" name="project_reference"
                                        placeholder="Enter Project Reference"
                                        value="{{ old('project_reference') }}" autofocus>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <select name="due_date" id="due_date" class="form-select">
                                        ...
                                        @for ($i = 1; $i <= 12; $i++)
                                        <option value="{{ $i }}" {{ old("due_date") == $i ? 'selected' : '' }}>{{ $i }} {{ $i > 1 ? "Weeks" : "Week" }}</option>
                                        @endfor
                                      </select>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" id="remarks"
                                        rows="3" placeholder="Enter Order Remarks">{{ old('remarks') }}</textarea>
                                    @error('remarks')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
