                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        @if(session()->has('route'))
                               <a href="{{ route('admin.sales.edit', $order->id) }}" class="btn btn-sm btn-primary me-1"><i
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs nav-bordered mb-3">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.sales.edit', $order->id) }}" class="nav-link">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="order-info-tab">
                                        <form id="orderForm" method="POST"
                                            action="{{ route('admin.sales.save-equipment-info', $order->id) }}"
                                        ...
                                        {{-- @include('admin.sales.edit.parts') --}}
                                        {{-- @include('admin.sales.edit.add-parts') --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                              ...
                              @else
                                <a href="{{ route('admin.sales.edit', $order->id) }}" class="btn btn-sm btn-primary me-1"><i
                                        class="mdi mdi-chevron-double-left me-1"></i>Back</a>
                            @endif
                                        <a href="{{ route('admin.sales.index') }}" class="btn btn-sm btn-danger me-1"><i
...
@push('scripts')
    ...
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.sales.add-part') }}",
            data: formData,
            dataType: 'json',
            success: function (data) {
