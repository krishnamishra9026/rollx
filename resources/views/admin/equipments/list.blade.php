...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                                ...
                                <a href="{{ route('admin.equipments.index') }}" class="btn btn-sm btn-primary float-end me-1"><i
                                    ...
                                    <button type="submit" class="btn btn-sm btn-danger float-end me-1" form="filterForm"><i
                                     ...
                                     <a href="{{ route('admin.equipments.exports') }}" class="btn btn-sm btn-success float-end me-1"><i
                                    ></i>Export</a>
        ...
        @include('admin.equipments.filter')
        <div class="row">
            <div class="col-12">
                <div class="card">
                                ...
                                <table id="basic-datatable" class="table table-striped border dt-responsive nowrap w-100"
                                    ...
                                    <thead class="text-dark">
                                        <tr>
                                            ...
                                            <th class="fw-bold">Customer / Company</th>
                                            <th class="fw-bold">Installation Date</th>
                                            <th class="fw-bold">Installation Address</th>
                                            <th class="fw-bold">Warranty Upto</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($equipments as $equipment)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('admin.equipments.show', $equipment->id) }}"
                                                    class="text-body fw-semibold">{{ $equipment->equipment_name }}</a></td>

                                                <td>{{ $equipment->serial_number }}</td>
                                                <td>
                                                    <a href="{{ route('admin.customers.show', $equipment->user_id) }}"
                                                        class="text-body fw-semibold">{{ $equipment->customer->company }}</a>
                                                </td>
                                                <td>{{ \Carbon\Carbon::parse($equipment->installation_date)->format('M d, Y') }}</td>
                                                <td class="text-start">
                                                    {{ $equipment->address->address }}
                                                    <br>{{ $equipment->address->city }}
                                                    {{ $equipment->address->country }}
                                                    {{ $equipment->address->zipcode }}
                                                </td>
                                                <td>{{ $equipment->warranty_upto == "custom" ?\Carbon\Carbon::parse( $equipment->warranty_date )->format('M d, Y') : $equipment->warranty_upto.' Weeks'}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <form id='delete-form{{ $equipment->id }}'
                                                            action='{{ route('admin.equipments.destroy', $equipment->id) }}'
                                                            method='POST'>
