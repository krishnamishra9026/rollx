                    ...
                    <div class="card-header ">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-12 mt-1 text-left">
                                <a href="{{ route('admin.products.export', ['product' => request('product'), 'order_date' => request('order_date'), 'order' => request('order'), 'status' => request('status') ]) }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="col-md-3 col-sm-12 mt-1 text-center" style="display: block;">
                                <a href="{{ route('admin.products.download.sample.csv') }}" class="btn btn-sm btn-secondary" style="float: center;"><i class="mdi mdi-download"></i> Download Sample CSV</a>
                            </div>
                        </div>
