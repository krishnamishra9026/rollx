...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form id="superadminForm" method="POST" action="{{ route('admin.users.update', $superadmin->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <select id="gender" class="form-select" name="gender">
                                        ...
                                        <option value="Male"
                                            {{ old('gender', $superadmin->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                        <option value="Female"
                                            {{ old('gender', $superadmin->gender) == 'Female' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                ...
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <select id="statuses" class="form-select" name="status">
                                        ...
                                        <option value="1" {{ old('status', $superadmin->status) == 1 ? 'selected' : '' }}>
                                            Enable</option>
                                        <option value="0" {{ old('status', $superadmin->status) == 0 ? 'selected' : '' }}>
                                            Disable</option>
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="{{ $superadmin->avatar }}" class="mt-2" width="100"
                                        height="100" />
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <select id="role" class="form-select @error('role') is-invalid @enderror"
                                        ...
                                        <option value="{{ $role->name }}"
                                            {{ in_array($role->name, old('role', [])) || (isset($superadmin) && $superadmin->roles->pluck('name')->contains($role->name)) ? 'selected' : '' }}>
                                            {{ $role->name }}</option>
                                            @endif
                                        @endforeach
