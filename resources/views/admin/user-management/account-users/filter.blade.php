<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.account-users.index') }}">
                    <div class="row">
                        ...
                        <div class="col-sm-2 mb-2">
                            ...
                            <select name="status" id="statuses" class="form-select form-control-sm">
                                <option value=""></option>
                                <option value="Yes" {{ $filter['status'] == "Yes" ? "selected" : "" }}>Yes</option>
                                <option value="No" {{ $filter['status'] == "No" ? "selected" : "" }}>No</option>
                            </select>
                        </div>
                        <div class="col-sm-2 mb-2 text-end">
                            ...
                            <a href="{{ route('admin.account-users.index') }}" class="btn btn-sm btn-dark ms-1"
