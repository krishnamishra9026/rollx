...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('admin.admins.create') }}" class="btn btn-sm btn-dark float-end"><i
        ...
        @include('admin.user-management.admins.filter')
        <div class="row">
            <div class="col-12">
                <div class="card">
                                        ...
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <td class="table-user">
                                                    ...
                                                    <img @isset($admin->avatar) src="{{ asset('storage/uploads/admin/' . $admin->avatar) }}" @else src="{{ asset('assets/images/users/avatar.png') }}" @endisset
                                                ...
                                                <td><input type="checkbox" id="switch{{ $admin->id }}"
                                                    ...
                                                    <label for="switch{{ $admin->id }}" data-on-label="Yes" data-off-label="No"></label>
                                                </td>
                                                <td class="text-end">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(".status").change(function() {
            var url = '{{ route("admin.admins.change-status", ":id") }}';
