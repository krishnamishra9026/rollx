...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit superadmin</h4>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <form id="superadminForm" method="POST" action="{{ route('admin.superadmins.update', $superadmin->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="firstname" name="firstname"
                                    placeholder="Enter First Name" value="{{ old('firstname', $superadmin->firstname) }}">
                                @error('firstname')
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="lastname" name="lastname"
                                    placeholder="Enter Last Name" value="{{ old('lastname', $superadmin->lastname) }}">
                                @error('lastname')
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Enter Email Address" value="{{ old('email', $superadmin->email) }}">
                                @error('email')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>                           
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Enter Phone Number" value="{{ old('phone', $superadmin->phone) }}">
                                @error('phone')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                                <input id="dial-code" name="dialcode" type="hidden"
                                    value="{{ isset($superadmin) ? $superadmin->dialcode : '' }}">
                            </div>
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="gender" class="form-select" name="gender">
                                    ...
                                    <option value="Male" {{ old('gender', $superadmin->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ old('gender', $superadmin->gender) == 'Female' ? 'selected' : '' }}>Female
                                    </option>
                                    <option value="Other" {{ old('gender', $superadmin->gender) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="statuses" class="form-select" name="status">
                                    ...
                                    <option value="1" {{ old('status', $superadmin->status) == 1 ? "selected" : ""  }}>Enable</option>
                                    <option value="0" {{ old('status', $superadmin->status) == 0 ? "selected" : ""  }}>Disable</option>
                                </select>
                            ...
                            <div class="col-sm-6">
                                ...
                                @endif
                                <img id="preview_img" src="{{ $superadmin->avatar }}" class="mt-2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    placeholder="Enter Address" value="{{ old('address', $superadmin->address) }}">
                                @error('address')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 mb-2 {{ $errors->has('city') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="city" name="city"
                                    placeholder="Enter City" value="{{ old('city', $superadmin->city) }}">
                                @error('city')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 mb-2 {{ $errors->has('state') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="state" name="state"
                                    placeholder="Enter State" value="{{ old('state', $superadmin->state) }}">
                                @error('state')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="zipcode" name="zipcode"
                                    placeholder="Enter Zipcode" value="{{ old('zipcode', $superadmin->zipcode) }}">
                                @error('zipcode')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        var iti = window.intlTelInput(input, {
            initialCountry: "{{ old('iso2', $superadmin->iso2) }}",
