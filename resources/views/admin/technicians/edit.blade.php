...
@section('content')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <button type="submit" class="btn btn-sm btn-danger" form="technicianForm"><i
    ...
    <div class="row">
        <div class="col-12">
            <form id="technicianForm" method="POST" action="{{ route('admin.technicians.update', $technician->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="firstname" name="firstname"
                                    placeholder="Enter First Name" value="{{ old('firstname', $technician->firstname) }}">
                                @error('firstname')
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="lastname" name="lastname"
                                    placeholder="Enter Last Name" value="{{ old('lastname', $technician->lastname) }}">
                                @error('lastname')
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Enter Email Address" value="{{ old('email', $technician->email) }}">
                                @error('email')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 mb-2 {{ $errors->has('email_additional') ? 'has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" id="email_additional" name="email_additional"
                                    placeholder="Enter Email Address (Additional)" value="{{ old('email_additional', $technician->email_additional) }}">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Enter Phone Number" value="{{ old('phone', $technician->phone) }}">
                                @error('phone')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <select id="gender" class="form-select" name="gender">
                                    ...
                                    <option value="Male" {{ old('gender', $technician->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ old('gender', $technician->gender) == 'Female' ? 'selected' : '' }}>Female
                                    </option>
                                    <option value="Other" {{ old('gender', $technician->gender) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div class="col-sm-6">
                                ...
                                @endif
                                <img id="preview_img" src="{{ $technician->avatar }}" class="mt-2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    placeholder="Enter Address" value="{{ old('address', $technician->address) }}">
                                @error('address')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 mb-2 {{ $errors->has('city') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="city" name="city"
                                    placeholder="Enter City" value="{{ old('city', $technician->city) }}">
                                @error('city')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-sm-6 mb-2 {{ $errors->has('state') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="state" name="state"
                                    placeholder="Enter State" value="{{ old('state', $technician->state) }}">
                                @error('state')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-6 mb-2 {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="zipcode" name="zipcode"
                                    placeholder="Enter Zipcode" value="{{ old('zipcode', $technician->zipcode) }}">
                                @error('zipcode')
                                    <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        var iti = window.intlTelInput(input, {
            initialCountry: "{{ old('iso2', $technician->iso2) }}",
