                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"
                                        rows="3" placeholder="Enter Job Description">{{ old('description') }}</textarea>
                                    @error('description')
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <select name="address" id="address" class="form-select"
                                        onchange="getEquipmentByAddress()">
                                        <option value="">Choose Address</option>
                                         @foreach ($addresses as $address)
                                                <option value="{{ $address->id }}"
                                                    {{ $address->id == old('address') ? 'selected' : '' }}>
                                    ...
                                    <select name="equipment" id="equipment" class="form-select" onchange="getSerialNumber();">
                                        ...
                                        @foreach ($equipments as $equipment )
                                         <option value="{{ $equipment->id }}" data-serial-no="{{ $equipment->serial_number }}"
                                                    {{ $equipment->id == old('equipment') ? 'selected' : '' }}>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="serial_number" id="serial_number" class="form-control @error('serial_number') is-invalid @enderror" placeholder="Enter Serial No." value="{{ old('serial_number') }}">
                                    ...
                                    <select name="service_type" id="service_type" class="form-select" data-toggle="select2">
                                        ...
                                        @foreach ($services as $service)
                                            <option value="{{ $service->id }}"
                                                {{ $service->id == old('service_type') ? 'selected' : '' }}>
                                                {{ $service->type }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="technician" id="technician" class="form-select" data-toggle="select2">
                                        ...
                                        @foreach ($technicians as $technician)
                                            <option value="{{ $technician->id }}"
                                                {{ $technician->id == old('technician') ? 'selected' : '' }}>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    <input id="timepicker" type="time" name="start_time" placeholder="Choose Start Time" value="{{old('start_time')}}"
                                ...
                                <div class="col-md-3" id="timepicker-input-group2">
                                    <input id="timepicker" type="time" name="end_time"  value="{{old('end_time')}}" placeholder="Choose End Time"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <textarea name="remark" class="form-control @error('remark') is-invalid @enderror" id="remark" rows="3"
                                        placeholder="Enter Job remark">{{ old('remark') }}</textarea>
                                    @error('remark')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <input type="checkbox" name="free_of_cost" id="free_of_cost" value="yes">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    <input type="checkbox" name="add_on_calendar" id="add_on_calendar" value="yes">
