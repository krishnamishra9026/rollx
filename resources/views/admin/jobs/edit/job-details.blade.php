            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('admin.jobs.index') }}" class="btn btn-sm btn-primary me-1"><i
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="job-details-tab">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-4"  id="timepicker-input-group2">
                                                        ...
                                                        <span class="uploaded-gallery">
                                                            ...
                                                            <span class="image-container">
                                                                ...
                                                                <div class="image-delete-button">
                                                                    <a href="{{ asset('storage/uploads/jobs/'.$job->id.'/images'.'/'.$image->name) }}" download="{{ $image->name }}" class="btn btn-sm btn-dark"><i class="uil-image-download"></i> </a>
