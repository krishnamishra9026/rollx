                                    ...
                                    <tbody>
                                        @foreach ($franchises as $franchise)
                                            <tr>
                                                <td>{{ $franchise->id }}</td>
                                                <td class="table-user">
                                                    <img height="30" width="30" @isset($franchise->avatar) src="{{ asset('storage/uploads/franchise/' . $franchise->avatar) }}" @else src="{{ asset('assets/images/users/avatar.png') }}" @endisset
