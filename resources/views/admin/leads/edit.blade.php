...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form id="franchiseForm" method="POST" action="{{ route('admin.leads.update', $lead->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('company') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="company" name="company"
                                        placeholder="Enter Company Name" value="{{ old('company', $lead->company) }}">
                                    @error('company')
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="zipcode" name="zipcode"
                                        placeholder="Enter Zipcode" value="{{ old('zipcode', $lead->zipcode) }}">
                                    @error('zipcode')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-sm-12 mb-2 {{ $errors->has('remarks') ? 'has-error' : '' }}">
                                    ...
                                    <textarea class="form-control" id="remarks" name="remarks"
                                        placeholder="Write remarks here">{{ old('remarks', $lead->remarks) }}</textarea>
                                    @error('remarks')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('firstname') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="firstname" name="firstname"
                                        placeholder="Enter First Name" value="{{ old('firstname', $lead->firstname) }}">
                                    @error('firstname')
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('lastname') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="lastname" name="lastname"
                                        placeholder="Enter Last Name" value="{{ old('lastname', $lead->lastname) }}">
                                    @error('lastname')
                                        <span id="name-error" class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('email_additional') ? 'has-error' : '' }}">
                                    ...
                                    <input type="email" class="form-control" id="email_additional" name="email_additional"
                                        placeholder="Enter Email Address (Additional)" value="{{ old('email_additional', $lead->email_additional) }}">
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('alternate_phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="alternate_phone" name="alternate_phone"
                                        placeholder="Enter Company Phone Number" value="{{ old('alternate_phone', $lead->alternate_phone) }}">
                                    ...
                                    <input id="alternate-dial-code" name="alternate_dialcode" type="hidden"
                                        value="{{ old('alternate_dialcode', $lead->alternate_dialcode) }}">
                                </div>
                                ...
                                <div class="col-sm-6 mb-2 {{ $errors->has('helpline_phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="helpline_phone" name="helpline_phone"
                                        placeholder="Enter Helpline Phone Number" value="{{ old('helpline_phone', $lead->helpline_phone) }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="{{ $lead->avatar }}" class="mt-2"
...
@push('scripts')
    ...
    <script>
        ...
        var iti = window.intlTelInput(input, {
            initialCountry: "{{ old('iso2', $lead->iso2) }}",
