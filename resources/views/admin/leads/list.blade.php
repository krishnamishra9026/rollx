                                    ...
                                    <tbody>
                                        @foreach ($leads as $lead)
                                            <tr data-id="{{ $lead->id }}">
                                                ...
                                                <td>                                                  
                                                <input type="datetime-local" data-id="{{ $lead->id }}" id="next_call_datetime" name="next_call_datetime" value="{{ $lead->next_call_datetime }}" min="{{ date('Y-m-d H:i') }}" class="form-control datetimepicker" required >
                                                </td>
                                                <td class="text-end">
