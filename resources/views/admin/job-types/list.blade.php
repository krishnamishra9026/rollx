            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('admin.job-types.create') }}" class="btn btn-sm btn-dark float-end"><i
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100" style="font-size: 14px;">
                                    <thead class="bg-dark">
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('admin.job-types.edit', $service->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $service->id }}'
                                                            action='{{ route('admin.job-types.destroy', $service->id) }}'
                                                            method='POST'>
        ...
        $("#delete-all").click(function(e) {
            rows = [], $("input:checkbox[name=rows]:checked").each(function() {
                ...
                t.isConfirmed && ($("#delete-all").text("Deleting..."), e.preventDefault(), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ route('admin.job-types.bulk-delete') }}",
                    data: {
                        job_types: rows,
                        _token: "{{ csrf_token() }}"
                    },
