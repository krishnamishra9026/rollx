                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        @if (session()->has('route'))
                            <a href="{{ route('admin.sales.equipment-info', $order->id) }}" class="btn btn-sm btn-primary me-1"><i
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs nav-bordered mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.sales.equipment-info', $order->id) }}" class="nav-link">
...
<script>
    function getChildCategories(id, type) {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('admin.sales.get-categories') }}',
            data: formData,
            dataType: 'json',
            beforeSend: function() {
                select.html("");
