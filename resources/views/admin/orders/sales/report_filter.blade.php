<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.order.sale.reports.index') }}" id="filterForm">
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-1 mt-1 text-end">
                            ...
                            <div class="page-title-box">
                                ...
                                <a href="{{ route('admin.order.sale.reports.index') }}" class="btn btn-sm btn-primary float-end me-1"><i class="mdi mdi-refresh"></i> Reset</a>
