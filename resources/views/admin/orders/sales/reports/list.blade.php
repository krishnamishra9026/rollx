            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="{{ route('admin.sale.reports.export', ['product' => request('product'),'franchise' => request('franchise'), 'order_date' => request('order_date'), 'order' => request('order'), 'status' => request('status') ]) }}" class="btn btn-sm btn-primary float-left me-1"><i
