...
class ChefController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.chefs.list', compact('chefs', 'filter'));
    }
    ...
    public function changeStatus($id)
    {
        ...
        if ($chef->status == true) {
            ...
            return redirect()->route('admin.chefs.index')->with('warning', 'Chef has been disabled successfully!');
        } else {
            Chef::find($id)->update(['status' => true]);
            return redirect()->route('admin.chefs.index')->with('success', 'Chef has been enabled successfully!');
        }
    }
