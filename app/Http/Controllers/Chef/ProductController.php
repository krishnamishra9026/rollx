...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('chef.products.list', compact('products', 'filter'));
    }
    ...
    public function create()
    {
        ...
        return view('chef.products.create', compact('nextId'));
    }
    ...
    {              
       ...
       if($request->hasfile('images'))
        ...
        return redirect()->route('chef.products.index')->with('success', 'Product created successfully');
    ...
    public function show(string $id)
    {
        ...
        return view('chef.products.show', compact('product'));
    }
    ...
    {
        $product       = Product::find($id);
        return view('chef.products.edit', compact('product'));
    }
    ...
    public function update(Request $request, string $id)
    {
       ...
       if($request->hasfile('images'))
        ...
        return redirect()->route('chef.products.index')->with('success', 'Product updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('chef.products.index')->with('success', 'Product deleted successfully');
    }
