...
class SalesReportExport implements FromCollection, WithHeadings, WithMapping, WithEvents, ShouldAutoSize
{
    ...
    public function __construct($startDate = null, $endDate = null, $status = null, $product = null, $franchise = null)
    {
    ...
    {
        $query = Sale::with(['product', 'franchise']);
        ...
        if ($this->franchise) {
            $query->where('franchise_id', $this->franchise);
        }              
